...
| Country           | `r length(unique(df$Country))` country(ies) in which the disasters occurred| | Region |`r length(unique(df$Region))` groupings of countries based on similarities in geography, temperature and other climate conditions |
